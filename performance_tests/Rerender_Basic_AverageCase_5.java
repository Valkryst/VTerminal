...
public class Rerender_Basic_AverageCase_5 {
    public static void main(final String[] args) throws IOException {
         ...
         * tiles do not change at-all. To test this scenario, we want to keep 95% of the screen unchanged while
         * generating a few new tiles which are reused to draw the rest of the screen.
         *
         * For this test, we will ensure that 5% of the cells change and 95% stay the same.
         *
         * ---
         *
        ...
        final int unchangedTiles = (int) (GlobalVariables.TOTAL_CELLS * 0.95);
