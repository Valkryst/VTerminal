...
public class Rerender_Basic_AverageCase_50 {
    public static void main(final String[] args) throws IOException {
         ...
         * tiles do not change at-all. To test this scenario, we want to keep 50% of the screen unchanged while
         * generating a few new tiles which are reused to draw the rest of the screen.
         *
         * For this test, we will ensure that 50% of the cells change and 50% stay the same.
         *
         * ---
         *
        ...
        final int unchangedTiles = (int) (GlobalVariables.TOTAL_CELLS * 0.50);
