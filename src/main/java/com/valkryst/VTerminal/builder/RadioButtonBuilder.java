...
public class RadioButtonBuilder extends ButtonBuilder {
    ...
    public RadioButtonBuilder(final JSONObject json) {
        ...
        final Character emptyButtonChar = json.getString("Empty Box Character").charAt(0);
        final Character checkedButtonChar = json.getString("Checked Box Character").charAt(0);
