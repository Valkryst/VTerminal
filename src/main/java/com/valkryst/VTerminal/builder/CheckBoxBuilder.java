...
public class CheckBoxBuilder extends ButtonBuilder {
    ...
    public CheckBoxBuilder(final JSONObject json) {
        ...
        final Character emptyBoxChar = json.getString("Empty Box Character").charAt(0);
        final Character checkedBoxChar = json.getString("Checked Box Character").charAt(0);
        final Boolean isChecked = json.getBoolean("Is Checked");
