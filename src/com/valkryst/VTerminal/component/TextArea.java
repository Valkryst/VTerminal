...
//                final AsciiCharacter tile = super.getTiles().getTileAt(x, y);
...
//        if (y_index_caret_visual < super.tiles.getHeight() - 1) {
//            changeVisualCaretPosition(x_index_caret_visual, y_index_caret_visual + 1);
//        }
//
//        if (y_index_caret_actual < maxVerticalCharacters - 1) {
...
//        if (x_index_caret_visual < super.tiles.getWidth() - 1) {
//            changeVisualCaretPosition(x_index_caret_visual + 1, y_index_caret_visual);
//        }
//
...
//        changeVisualCaretPosition(x_index_caret_visual, super.tiles.getHeight() - 1);
...
//        changeVisualCaretPosition(super.tiles.getWidth() - 1, y_index_caret_visual);
...
//        if (editable) {
//            for (final AsciiCharacter tile : super.tiles.getRow(newRowIndex)) {
...
//        for (final AsciiCharacter tile : super.tiles.getRow(rowIndex)) {
...
//
//        for (int y = yDifference ; y < super.tiles.getHeight() + yDifference ; y++) {
//            final AsciiString string = super.tiles.getString(y - yDifference);
//            final AsciiCharacter[] characters = string.getCharacters();
//
//            for (int x = xDifference ; x < super.tiles.getWidth() + xDifference ; x++) {
...
//
//        for (int x = 0 ; x < Math.min(maxHorizontalCharacters, text.length()) ; x++) {
...
//        final String[] strings = new String[super.tiles.getHeight()];
//
//        final StringBuilder sb = new StringBuilder();
//
//        for (int i = 0 ; i < super.tiles.getHeight() ; i++) {
...
//        }
//
//        if (rowIndex > super.tiles.getHeight()) {
//            throw new IllegalArgumentException("The row index cannot be above " + super.tiles.getHeight() +".");
//        }
//
...
//        for (final char[] anEnteredText : enteredText) {
//            Arrays.fill(anEnteredText, ' ');
//        }
//
//        for (int y = 0 ; y < super.tiles.getHeight() ; y++) {
//            for (int x = 0 ; x < super.tiles.getWidth() ; x++) {
