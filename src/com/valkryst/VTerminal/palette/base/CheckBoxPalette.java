...
public abstract class CheckBoxPalette<COLOR> extends ComponentPalette {
    ...
    /**
     * Constructs a CheckBoxPalette using the JSON representation of a color palette. If the given JSON
     ...
     */
    public CheckBoxPalette(JSONObject json) throws IOException, ParseException {
        if (json == null) {
            json = VJSON.loadJson("Palettes/Default.json");
        }

        final JSONObject buttonJson = (JSONObject) json.get("Check Box");
        if (buttonJson == null) {
