...
public class AbstractPaletteFactory {
     ...
     */
    public Palette createPalette(final RendererType rendererType) throws IOException, ParseException {
     ...
     *          If there's an error when parsing the JSON.
     */
    public Palette createPalette(final RendererType rendererType, final String filePath) throws IOException, ParseException {
