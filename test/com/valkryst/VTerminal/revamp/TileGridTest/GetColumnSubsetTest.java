...
public class GetColumnSubsetTest {
    ...
    public void testGetColumnSubset_withValidParams() {
        final AsciiCharacter[] columnSubset = StaticGrid.TILE_GRID.getColumnSubset(0, 1, 4);
    ...
    public void testGetColumnSubset_withLengthExceedingGridHeight() {
        ...
        final AsciiCharacter[] columnSubset = StaticGrid.TILE_GRID.getColumnSubset(0, 1, gridHeight);
    ...
    public void testGetColumnSubset_withRowIndexLessThanZero() {
        final AsciiCharacter[] columnSubset = StaticGrid.TILE_GRID.getColumnSubset(-1, 1, 4);
    ...
    public void testGetColumnSubset_withLengthLessThanOne() {
        final AsciiCharacter[] columnSubset = StaticGrid.TILE_GRID.getColumnSubset(0, 1, 0);
        Assert.assertEquals(columnSubset.length, 0);
    }
    ...
    public void testGetColumnSubset_withRowIndexExceedingGridHeight() {
        ...
        final AsciiCharacter[] columnSubset = StaticGrid.TILE_GRID.getColumnSubset(gridHeight, 1, 0);
        Assert.assertEquals(columnSubset.length, 0);
    }
    ...
    public void testGetColumnSubset_withColumnIndexExceedingGridWidth() {
        ...
        final AsciiCharacter[] columnSubset = StaticGrid.TILE_GRID.getColumnSubset(0, gridWidth, 0);
        Assert.assertEquals(columnSubset.length, 0);
    }
}
