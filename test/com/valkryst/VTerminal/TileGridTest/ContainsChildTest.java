...
public class ContainsChildTest {
    ...
    @Test
    public void testContainsChild_withValidChild() {
    ...
    @Test
    public void testContainsChild_withNullChild() {
        Assert.assertFalse(parentGrid.containsChild(null));
    }
}
